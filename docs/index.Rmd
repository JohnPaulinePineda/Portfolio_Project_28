...
|
| **[B]** The logistic curve formulated by plotting the predicted probabilities against the classification index using the logit values showed a non-logistic profile with predicted points clustered in groups.
|
| **[C]** The performance of the model is summarized as follows:
|      **[C.1]** Final model configuration is fixed due to the absence of a hyperparameter
|      **[C.2]** Apparent ROC Curve AUC = 0.99996
|      **[C.3]** Estimated probabilities were practically dichotomized into a limited set of values. 
|
...
|
| **[A]** The Firth's bias-reduced logistic regression model from both the <mark style="background-color: #CCECFF">**logistf**</mark> package was implemented. The <span style="color: #FF0000">UTI</span> response was regressed against the <span style="color: #FF0000">Age_24</span>, <span style="color: #FF0000">Contraceptive</span>, <span style="color: #FF0000">Condom</span>, <span style="color: #FF0000">LubricatedCondom</span>, <span style="color: #FF0000">Spermicide</span> and <span style="color: #FF0000">Diaphragm</span> predictors.
|
...
|
| **[B]** The logistic curve formulated by plotting the predicted probabilities against the classification index using the logit values showed a valid logistic profile with reasonably distributed predicted points.
|
| **[C]** The performance of the model is summarized as follows:
|      **[C.1]** Final model configuration involves maxit=1000
|      **[C.2]** Apparent ROC Curve AUC = 0.99996
|      **[C.3]** Estimated probabilities were reasonably distributed across a set of values. 
|
