...
|
| [PLR_R](https://www.tandfonline.com/doi/abs/10.1080/00401706.1970.10488634) implements a shrinkage method to deal with infinite estimates by pulling, on average, the original estimates towards zero. PLR_R penalizes the log-likelihood by subtracting a multiple of the sum of the squared coefficients while excluding the intercept from the sum, which is equivalent to penalization using normal prior densities. 
|
