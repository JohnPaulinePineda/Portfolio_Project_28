...
|
| **[A]** The robust logistic regression models which were able to sufficiently compensate for the quasi-complete condition through stable coefficient estimates and valid logistic profiles with reasonably distributed predicted points are the following :
...
|      **[A.4]**BGLM_CP : Bayesian Generalized Linear Model With Cauchy Priors (<mark style="background-color: #CCECFF">**logistf**</mark> package)
|
